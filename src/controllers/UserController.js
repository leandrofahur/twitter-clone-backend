...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, username, email, usersRepository, userAlreadyExists, user, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        _a = request.body, username = _a.username, email = _a.email;
    ...
    UserController.prototype.findPostsByUser = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, userPosts, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userRepository = typeorm_1.getCustomRepository(UsersRepository_1.UsersRepository);
                        return [4 /*yield*/, userRepository.find({
                                relations: ['posts'],
                            })];
                    case 1:
                        userPosts = _a.sent();
                        return [2 /*return*/, response.status(201).json(userPosts)];
                    case 2:
                        error_2 = _a.sent();
